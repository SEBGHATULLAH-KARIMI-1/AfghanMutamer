...
import {
  FiGrid, FiUsers, FiCreditCard, FiBarChart2, FiUserCheck, FiSettings, FiMoon, FiShoppingCart, FiBriefcase,
} from 'react-icons/fi'
...
const MENU = [
  ...
  { to: '/companies', label: 'شرکت‌ها', icon: <FiBriefcase />, page: 'companies' },
